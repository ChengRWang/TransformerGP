...
# CROSS_VALIDATION_FILE = os.path.join(DATA_DIR, 'new_rice4k_cv_splits2.json')
CROSS_VALIDATION_FILE = os.path.join(DATA_DIR, 'rice4k_fold8.json')
EXP_FILE = os.path.join(DATA_DIR, 'rice4k_219/rice4k_exp.csv')
PHENOTYPES_FILE = os.path.join(DATA_DIR, 'rice4k_219/rice4k_ph.csv')
# SNP_FILE = os.path.join(DATA_DIR, 'rice18k_sw.csv')
RESULTS_DIR = os.path.join(DATA_DIR, 'rice4k_219')
